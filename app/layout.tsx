...
export const metadata: Metadata = {
  title: "TradeMad Americas - Premium Wood Products | Pine & Eucalyptus Lumber",
  ...
  authors: [{ name: "TradeMad Americas" }],
  creator: "TradeMad Americas",
  publisher: "TradeMad Americas",
  applicationName: "TradeMad Americas",
  category: "business",
  classification: "Wood Products & Timber Trading",
  robots: "index, follow",
  openGraph: {
    title: "TradeMad Americas - Premium Wood Products from South America",
    ...
    images: [
      {
        ...
        width: 1200,
        height: 630,
        alt: "TradeMad Americas - Premium Wood Products",
      },
    ],
  },
  twitter: {
    card: "summary_large_image",
    title: "TradeMad Americas - Premium Wood Products",
