...
export function UnderConstructionBanner() {
  ...
  return (
    <div className="fixed inset-0 z-50 overflow-hidden">
      <div className="absolute inset-0 pointer-events-auto bg-background/60 dark:bg-background/75 backdrop-blur-lg" />

      <div className="absolute inset-0 pointer-events-none opacity-[0.05] dark:opacity-10">
        <div
